...
body  {
  background-image: url("img/Patient-1.jpg");
  background-color: #cccccc;ctor
}
			...
			<div class="col-md-4 offset-md-4">
				<div class="card paint-card">
					<div class="card-body">
						...
						<br>
						<p class="text-center">Dont't Have An Account ?</p>
						<br>

						<p class="text-center">
							<a href="signup.jsp" class="text-decoration-none">Create
								Account</a>
						</p>
